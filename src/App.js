        ...
        <Layout style={{ minHeight: "100vh" }}>
          <Sider collapsible collapsed={collapsed} onCollapse={onCollapse}>
            ...
            <Menu theme="dark" defaultSelectedKeys={["1"]} mode="inline">
              <SubMenu key="sub1" icon={<UserOutlined />} title="home page">
                <Menu.Item key="1">
                ...
                <Menu.Item key="3">
                  <Link to="/SideInformation">Slider</Link>
                </Menu.Item>
              </SubMenu>
          ...
          <Layout className="site-layout">
            <Header className="site-layout-background" style={{ padding: 0,textAlign:"center",fontSize: 17,fontWeight:700  }} >{title}</Header>
            <Content style={{ margin: "20px 16px" }}>
              ...
              >
                  ...
                  <Route path="/WebsiteStatistics" component={WebsiteStatistics}/>
